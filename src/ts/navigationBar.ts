...
class Navbar extends HTMLElement {
    ...
    connectedCallback() {
        ...
        type Data = {header: HTMLElement, button: HTMLButtonElement, nav: HTMLElement, links: NodeList}

        const data: Data = {
            header: this.shadowRoot?.querySelector("header") as HTMLElement,
            button: this.shadowRoot?.querySelector("header navbar-btn") as HTMLButtonElement,
            nav: this.shadowRoot?.querySelector("header nav") as HTMLElement,
            links: document.querySelectorAll("navigation-bar a") as NodeList,
        };
